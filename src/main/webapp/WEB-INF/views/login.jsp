...
<head>
	...
	<link rel="icon" href="${pageContext.request.contextPath}/resources/images/shambhu.png" type="image/x-icon" >
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
				<form class="login100-form validate-form" id="form-login" action="loginProcess" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid username is required">
						<input class="input100" type="text" maxlength="10" id="username" name="username" placeholder="Username">
