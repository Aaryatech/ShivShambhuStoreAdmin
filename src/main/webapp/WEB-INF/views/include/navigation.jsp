	...
	<div class="container" id="main-container">
		...
		<div id="sidebar" class="navbar-collapse collapse">
			...
			<a class="navbar-brand" href="#"
				...
				src="${pageContext.request.contextPath}/resources/images/shambhu.png"
			...
			<ul class="nav nav-list">
				...
				<a onclick="selectSubMod(999,9999)" href="${pageContext.request.contextPath}/userEdit/${userInfo.userId}/0">Edit Profile </a>
					</li>
					</ul>
				<%-- 		
					<c:choose>
