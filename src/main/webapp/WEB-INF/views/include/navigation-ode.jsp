...
<%@ page import="com.ats.shivstore.common.Constants"%>
<%@ page import="com.ats.shivstore.common.Commons"%>
				...
				<div id="sidebar" class="navbar-collapse collapse">
					...
					<ul class="nav nav-list">
						...
						<ul class="submenu">
							...
							<a href="${pageContext.request.contextPath}/showPasswordChange">Change
								Password</a>
							</li>
						</ul>
