			...
			<div class="row">
				<div class="col-md-12">
					<div class="box">
						<div class="box-title">
							<h3>
								<i class="fa fa-bars"></i>BOM Request List
							</h3>
							<div class="box-tool">
								<div class="box-tool">
						...
						<div class="box-content">
							<form action="${pageContext.request.contextPath}/showBOMReqests"
										...
										<table id="table1" class="table table-advance">
											<thead>
												<tr class="bgpink">
													...
													<th class="col-md-2">Sub Plant</th>
													<th class="col-md-1">BOM Date</th>
													<th class="col-md-1">BOM Type</th>
													<th class="col-md-1">Production Id</th>
													<th class="col-md-1">Action</th>
												</tr>
											</thead>
											
											<tbody>
												<c:forEach items="${bomHeadList}" var="bom" varStatus="count">
													<tr>
														
														<td width="2%"  ><c:out
																value="${count.index+1}" /></td>
														<td align="left" ><c:out
																value="${bom.plantName}" /></td>
														<td align="left" ><c:out
																value="${bom.subplantName}" /></td>
																<td  ><c:out
																value="${bom.bomReqDate}" /></td>
														 
														<c:set var="bomType" value="o"></c:set>

														<c:choose>
															<c:when test="${bom.isManual==1}">
																<c:set var="bomType" value="Manual"></c:set>
															</c:when>
															<c:otherwise>
																<c:set var="bomType" value="Automatic"></c:set>
															</c:otherwise>
														</c:choose>
